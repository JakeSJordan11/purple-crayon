...
build:
	...
	clang -framework AppKit -framework WebKit -framework CoreGraphics -framework CoreFoundation \
		-o $(BUNDLE)/Contents/MacOS/$(APP) spring/event_tap_callback.c spring/main.c spring/register_event_tap.c spring/request_mach_port_rights.c spring/run_loop.c Bud/ClickableWebView.m Bud/Panel.m
